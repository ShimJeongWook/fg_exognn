...
from src.utils.project import DATA_ROOT, AIRKOREA_ROOT, KNOWAIR_ROOT, GAGNN_ROOT
...
def get_dataset_info(dataset):
    d = {
         # AirKorea (bundled): 306 nodes, 12 variables
         '24_24_AK': [str(AIRKOREA_ROOT / '24_24'), str(AIRKOREA_ROOT / 'adj_mx.npy'), 306],
         # KnowAir (bundled): 184 nodes
         '24_24_KA': [str(KNOWAIR_ROOT / '24_24'), str(KNOWAIR_ROOT / 'adj_mx.npy'), 184],
         # GAGNN (bundled): 209 nodes
         '24_24_G': [str(GAGNN_ROOT / '24_24'), str(GAGNN_ROOT / 'adj_mx.npy'), 209],
         # Original CauAir AirKorea-1341 dataset (NOT bundled here); place data under ./data
